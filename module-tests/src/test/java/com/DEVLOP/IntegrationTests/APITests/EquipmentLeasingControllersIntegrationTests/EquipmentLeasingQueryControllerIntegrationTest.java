...
@Testcontainers
public class EquipmentLeasingQueryControllerIntegrationTest {
    @Container
    ...
    @Test
    public void GetEquipmentLeasingByID() throws Exception {
        MvcResult mvcResult = mockMvc.perform(get("/v1/equipmentLeasing/{id}",1))
    ...
    @Test
    public void GetEquipmentLeasingByCode() throws Exception {
        EquipmentLeasing equipmentLeasing = equipmentLeasingRepo.ReturnEquipmentLeasingByID(1).orElseThrow();
        String code = equipmentLeasing.getLeasingContractCode();


        MvcResult mvcResult = mockMvc.perform(get("/v1/equipmentLeasing/code/{code}",code))
                .andExpect(request().asyncStarted())
                .andReturn();

        mockMvc.perform(asyncDispatch(mvcResult))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.leasingContractCode").value(code))
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andReturn()
                .getResponse()
                .getContentAsString();
    ...
    @Test
    public void GetEquipmentLeasingByIDList() throws Exception {
        // Arrange
        ...
        // Act
        MvcResult mvcResult = mockMvc.perform(post("/v1/equipmentLeasing/list")
    ...
    @Test
    public void GetEquipmentLeasingList() throws Exception {
        // Act
        MvcResult mvcResult = mockMvc.perform(get("/v1/equipmentLeasing"))
                .andExpect(request().asyncStarted())
                .andReturn();
