...
public class EquipmentPersistenceEntity extends BaseEntity{
    @Id
    ...
    private EquipmentTypePersistenceEntity equipmentTypeID;
    ...
    public EquipmentTypePersistenceEntity getEquipmentTypeID() {
        return equipmentTypeID;
    }

    public void setEquipmentTypeID(EquipmentTypePersistenceEntity equipmentTypeID) {
